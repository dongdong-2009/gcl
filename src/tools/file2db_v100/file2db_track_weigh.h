...
private:
   ...
   static int doConvert2Xml_chengDeChengSheng(const std::vector<std::string> & sFileRows, const CxFileSystem::PathInfo & pathInfo, std::string & sOut41108, std::string &sOutMessage);
