...
const std::string CS_Lua_Measure_ID = "id";
const std::string CS_Lua_Measure_Type = "type";
const std::string CS_Lua_Measure_Q = "q";
const std::string CS_Lua_Measure_T = "t";
const std::string CS_Lua_Measure_Length = "length";
const std::string CS_Lua_Measure_V = "v";
const std::string CS_Lua_Measure_URL = "url";
const std::string CS_Lua_Measure_SRC = "src";
