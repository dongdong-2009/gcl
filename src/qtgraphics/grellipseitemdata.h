...
#ifndef GRELLIPSEITEMDATA_H
#define GRELLIPSEITEMDATA_H
#include "gritemdatainterface.h"
#include "fillstyle.h"

class GREllipseItemData : public GRItemDataInterface
{
public:
    GREllipseItemData();
    ~GREllipseItemData();
