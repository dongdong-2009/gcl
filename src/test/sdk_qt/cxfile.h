...
public:
     ...
     * @return
     */
    static inline std::string load(const std::string& sFileName) { std::string r; load(sFileName, r, 1024 * 1024 * 30); return r; }

    static inline bool load(const std::string& sFileName, std::string& sOut) { return load(sFileName, sOut, 1024 * 1024 * 30); }
